...
import { Scissors, Route, Layers, ArrowUpRight } from "lucide-react"
...
export function FeatureSections() {
  ...
  const sections = [
    { id: "packetSplit", icon: Scissors, ...t.features.packetSplit },
    { id: "networkJourney", icon: Route, ...t.features.networkJourney },
    { id: "reassembly", icon: Layers, ...t.features.reassembly },
  ]
